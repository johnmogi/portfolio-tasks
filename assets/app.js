...
$(document).ready(function() {
    ...
    let tasks = loadTasks();
    let currentView = 'table'; // table, card, list
    let tasksTable = null;
    ...
    function switchView(viewType) {
        ...
        $(`#${currentView}ViewBtn`).removeClass('active');
        $(`#${viewType}ViewBtn`).addClass('active');
        
        // Hide current view
        $(`#tasks${currentView.charAt(0).toUpperCase() + currentView.slice(1)}Container`).removeClass('active');
    ...
    // ==========================================
    // VIEW SWITCHING & RENDERING FUNCTIONS
    // ==========================================
...
function renderListView() {
    ...
    if (tasks.length === 0) {
        ...
        tasks.forEach(task => {
            const listItemHtml = createTaskListItem(task);
    ...
    function createTaskCard(task) {
        ...
        const cardColor = task.color || '#888888';
        
        return `
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="card task-card" style="--card-color: ${cardColor};">
                    <div class="task-card-header">
                        <div class="task-card-category">
                            <span class="category-dot" style="background-color: ${cardColor}"></span>
                    ...
                    <div class="task-card-body">
                        ...
                        <div class="task-card-time">
                            ...
                            ${task.deadline ? `<div class="time-display ${overdue ? 'overdue' : ''}">
                    ...
                    <div class="task-card-footer">
                        <div class="task-card-actions">
                            <button class="btn btn-sm btn-outline-primary task-card-btn edit-task"
                                    data-task-id="${task.id}" title="Edit task">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <button class="btn btn-sm btn-outline-danger task-card-btn delete-task"
    ...
    function createTaskListItem(task) {
        ...
        return `
            <div class="list-group-item task-list-item ${isCompleted ? 'completed' : ''}">
                <div class="task-list-content">
                    ...
                    <div class="task-list-info">
                        ...
                        <div class="task-list-meta">
                            ${task.category ? `<span class="category-badge">
                                <span class="category-dot" style="background-color: ${task.color || '#888888'}"></span>
                                ${task.category}
                            </span>` : ''}
                            ...
                            ${task.deadline ? `<span class="time-display ${overdue ? 'overdue' : ''}">
                                <i class="fas fa-clock"></i>
                                ${formatDate(task.deadline)}
                            </span>` : ''}
                        </div>
                        ${task.description ? `<div class="mt-1" style="font-size: 0.875rem; color: #6c757d;">${task.description}</div>` : ''}
                    </div>
                    <div class="task-list-actions">
                        <button class="btn btn-sm btn-outline-primary task-list-btn edit-task"
                                data-task-id="${task.id}" title="Edit task">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-sm btn-outline-danger task-list-btn delete-task"
                                data-task-id="${task.id}" title="Delete task">
